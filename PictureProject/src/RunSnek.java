...
public class RunSnek extends FlexiblePictureExplorer{
	private SimplePicture playScreen;
	private Graphics2D gPlay;
	RunSnek(int width, int height){
	...
	class Board extends JPanel implements Runnable, KeyListener{
		public static final int width = 400;
		public static final int height = 400;
		
		//graphics
		private Graphics2D g2d = gPlay;
	...
	public static void main(String[] args) {
		RunSnek test = new RunSnek(1200,900);
	}
}
